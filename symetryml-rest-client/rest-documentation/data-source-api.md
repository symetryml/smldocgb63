...
SymetryML supports connecting to Snowflake data warehouses using Snowflake's Snowpark Container Services (CP3O) for distributed processing.

| field                                          | Required    | Description                                                                                                                     |
| ---------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `snowflake.account`                            | **Required** | Snowflake account identifier (e.g., `XYZZZZZ-ZBC00000`)                                                                        |
| `snowflake.account.role`                       | **Required** | Role to connect to the Snowflake account with (e.g., `ACCOUNTADMIN`)                                                          |
| `snowflake.user`                               | **Required** | User to connect to the Snowflake account with (e.g., `zzzuser`)                                                               |
| `snowflake.auth.private.key.raw`              | **Required** | String content of the private key to authorize the connection to the account                                                   |
| `snowflake.data.database`                      | **Required** | Name of the database containing the data                                                                                       |
| `snowflake.data.schema`                        | **Required** | Name of the schema containing the data                                                                                         |
| `snowflake.data.table`                         | **Required** | Name of the table containing the data                                                                                          |
| `snowflake.cp3o.compute.pool.instance.family`  | **Required** | Compute pool instance family to use (e.g., `CPU_X64_S`)                                                                        |
| `snowflake.cp3o.compute.pool.max.nodes`        | **Required** | Maximum number of nodes in the compute pool (e.g., `3`)                                                                        |
| `snowflake.cp3o.compute.pool.min.nodes`        | **Required** | Minimum number of nodes in the compute pool (e.g., `1`)                                                                        |
| `snowflake.cp3o.worker.total`                  | **Required** | Number of workers that share the update task (e.g., `3`)                                                                       |
| `snowflake.cp3o.data.table.order.by.clause`    | **Required** | SQL clause used to order the rows of the table so that the workers can partition it properly (e.g., `ROW_INDEX ASC`)          |
| `snowflake.job.warehouse`                      | Optional    | Snowflake warehouse to use for queries. **Default: `WH_NB`**                                                                   |
| `snowflake.job.warehouse.size`                 | Optional    | Size of the Snowflake warehouse to use for queries. **Default: `XSMALL`**                                                     |
| `snowflake.job.warehouse.auto.suspend`         | Optional    | Inactivity timeout in seconds of the Snowflake warehouse to use for queries. **Default: `120`**                               |
| `snowflake.job.role`                           | Optional    | Snowflake role to use in processing the job. **Default: `C3PO_APP_ROLE`**                                                     |
| `snowflake.list.roles`                         | Optional    | Boolean flag to show a list of Snowflake roles while browsing. **Default: `false`**                                           |
| `snowflake.cp3o.data.frame.max.size`           | Optional    | Maximum size of a Data Frame to use while updating SML projects in processing the job. **Default: `16384`**                   |
